...
app.post('/addindicadores', (req,res)=> {
    const ADD_QUERY = `insert into indicadores values ('${req.body.id}','${req.body.CalificacionCORFO}','${req.body.MisionUniversitaria}','${req.body.nombre}','${req.body.eje}','${req.body.FuenteInformacion}')`
